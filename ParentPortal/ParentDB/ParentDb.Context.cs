...
namespace ParentPortal.ParentDB
{
    ...
    public partial class BiWeeklyRCPNewEntities : DbContext
    {
        public BiWeeklyRCPNewEntities()
            : base("name=BiWeeklyRCPNewEntities")
        {
        }
        ...
        public DbSet<IEPExportStatu> IEPExportStatus { get; set; }
        ...
        public virtual int BehaviorReport_Trendline(Nullable<System.DateTime> startDate, Nullable<System.DateTime> eNDDate, Nullable<int> studentid, Nullable<int> schoolId, string behavior, string trendtype)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BehaviorReport_Trendline", startDateParameter, eNDDateParameter, studentidParameter, schoolIdParameter, behaviorParameter, trendtypeParameter);
        }
        ...
        public virtual int BiweeklyReport_Trendline(Nullable<System.DateTime> startDate, Nullable<System.DateTime> eNDDate, Nullable<int> studentid, Nullable<int> schoolId, string lessonPlanid, string trendtype)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BiweeklyReport_Trendline", startDateParameter, eNDDateParameter, studentidParameter, schoolIdParameter, lessonPlanidParameter, trendtypeParameter);
        }
    
        public virtual int BiweeklySessionReport(Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate, Nullable<int> studentId, string lessonPlan, Nullable<int> schoolId)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BiweeklySessionReport", startDateParameter, endDateParameter, studentIdParameter, lessonPlanParameter, schoolIdParameter);
        }
        ...
        public virtual ObjectResult<Referral_Dashboard_Result> Referral_Dashboard(Nullable<int> queueId, Nullable<int> schoolId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Referral_Dashboard_Result>("Referral_Dashboard", queueIdParameter, schoolIdParameter);
        }
